...
*/
  //oop
    ...
    $('#lbutton').click(()=>{
        let url = 'https://spreadsheets.google.com/feeds/list/1fjGodGgF4bPQg6CynkG0Al9oO33snSnx-X-1YrpwmV8/1/public/values?alt=json';
        p5j.loaded=0;
        //console.log(url);
        p5j.httpGet(url, 'jsonp', false, function(response) {
    ...
    $('#ubutton').click(()=>{
        if(p5j.arrarea.length>0){
          ...
          let exeurl = 'https://script.google.com/macros/s/AKfycbysby2hX3VU5kvYl0tbeLGwmpk9fJzljcA1pNoQDqKIiij_VHk7/exec';          
          let editurl = 'https://docs.google.com/spreadsheets/d/1fjGodGgF4bPQg6CynkG0Al9oO33snSnx-X-1YrpwmV8/edit#gid=0';
